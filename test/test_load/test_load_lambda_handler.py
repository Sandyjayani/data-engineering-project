...
def test_lambda_handler_success(mock_insert_data, mock_create_connection, mock_read_parquet):
    # Arrange
...
@patch('src.load.load_lambda_handler.create_connection')
@patch('src.load.load_lambda_handler.insert_data_into_tables')
def test_lambda_handler_insert_data_error(mock_insert_data, mock_create_connection, mock_read_parquet):
    # Arrange
    event = {'table_name': 'test_table'}
    context = {}

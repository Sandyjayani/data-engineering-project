...
def test_not_call_upload_function_if_no_new_data(
    mock_load_ingested_tables, upload_to_transformation_s3
):
    mock_load_ingested_tables.return_value = {}
    response = lambda_handler({}, {})
...
def test_calls_upload_function_if_new_data(
    mock_load_ingested_tables, upload_to_transformation_s3, test_new_data_dict
):
...
def test_logs_start_and_completion_of_execution(
    mock_load_ingested_tables, upload_to_transformation_s3, test_new_data_dict, caplog
):
    mock_load_ingested_tables.return_value = test_new_data_dict
    response = lambda_handler({}, {})

...
def test_new_data_dict():
    return {
        "address": pd.read_csv("test/test_transform/test_data/test_address.csv"),
        "counterparty": pd.read_csv(
            "test/test_transform/test_data/test_counterparty.csv"
        ),
        "currency": pd.read_csv("test/test_transform/test_data/test_currency.csv"),
        "department": pd.read_csv("test/test_transform/test_data/test_department.csv"),
        "design": pd.read_csv("test/test_transform/test_data/test_design.csv"),
        "payment_type": pd.read_csv(
            "test/test_transform/test_data/test_payment_type.csv"
        ),
        "payment": pd.read_csv("test/test_transform/test_data/test_payment.csv"),
...
def test_return_statement(
    mock_load_ingested_tables, upload_to_transformation_s3, mock_client
):
...
@patch("src.transform.transformation_lambda.upload_to_transformation_s3")
@patch(
    "src.transform.transformation_lambda.load_ingested_tables",
...
@patch("src.transform.transformation_lambda.upload_to_transformation_s3")
@patch("src.transform.transformation_lambda.load_ingested_tables")
def test_not_call_upload_function_if_no_new_data(
    mock_load_ingested_tables, upload_to_transformation_s3, mock_client
):
    mock_load_ingested_tables.return_value = {}
    with patch(
        "src.transform.transformation_lambda.transform_date", return_value=None
    ) as mock_transform_date:
        response = lambda_handler({}, {})
...
@patch("src.transform.transformation_lambda.upload_to_transformation_s3")
@patch("src.transform.transformation_lambda.load_ingested_tables")
def test_calls_upload_function_if_new_data(
    mock_load_ingested_tables,
    ...
    with patch(
        "src.transform.transformation_lambda.transform_counterparty", return_value=None
    ) as mock_transform_counterparty:
        response = lambda_handler({}, {})
...
@patch("src.transform.transformation_lambda.upload_to_transformation_s3")
@patch("src.transform.transformation_lambda.load_ingested_tables")
def test_logs_start_and_completion_of_execution(
    mock_load_ingested_tables,
    upload_to_transformation_s3,
    test_new_data_dict,
    caplog,

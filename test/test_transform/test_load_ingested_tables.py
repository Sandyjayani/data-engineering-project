...
def test_load_multiple_tables_from_s3(
    mock_get_timestamp, mock_get_transformation_timestamp, mock_client
):
...
@patch("src.transform.load_ingested_tables.get_transformation_timestamp")
@patch("src.transform.load_ingested_tables.get_ingestion_timestamp")
def test_if_timestamp_are_same(
    mock_get_timestamp, mock_get_transformation_timestamp, mock_client, caplog
):
    test_bucket = "smith-morra-ingestion-bucket"

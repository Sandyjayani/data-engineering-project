...
class TestUploadToS3:
    ...
    def test_confirmation_message_is_returned(
        ...
        assert upload_tables_to_s3(
                    mock_df, test_table, test_bucket
                ) == expected
    ...
    def test_correct_files_being_uploaded(self, mock_datetime, mock_client):
        ...
        test_key2 = (
                'test_table/2024/8/13/17-27/test_table-2024-08-13_17-27.csv'
                    )
...
class TestSaveTimestamps:
    ...
    def test_new_timestamp(self, mock_client):
        ...
        response = mock_client.get_object(
            Bucket=test_bucket,
            Key=f"{test_table}/timestamps.csv")
